function maxIntensityImage = MakeMaxZImage(fileReader,channels,timepoint,z_Range,pixelShiftX,pixelShiftY,nSeries)
...
maxIntensityImage = uint16(zeros(1024+pixelShiftX, 1024+pixelShiftY, numel(channels)));
